 ...
 */
 ...
 function dfi_initialize_components(){
	...
	wp_enqueue_style( 'style-dfi', plugins_url('/dynamic-featured-image/css/style-dfi.css') );
	
	//register scripts
    wp_register_script('dfi-scripts', plugins_url('/dynamic-featured-image/js/script-dfi.js'), array('jquery','media-upload','thickbox'));   
